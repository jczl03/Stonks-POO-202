...
public class ControlGraphicsBalance implements ActionListener{
    ...
    private static final String[] COMBOBOXITEMS={"Ingresos vs Gastos Totales","Ingresos vs Gastos (Mes)","Ingresos vs Gastos/Producto(Mes)","Ingresos vs Gastos por producto","Ingresos vs Gastos por producto(Mes)","Ingresos vs Gastos vs Ganancias Totales","Ingresos vs Gastos vs Ganancias Totales(Mes)"};
